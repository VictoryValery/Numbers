...
class GameFinishedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Toast.makeText(requireContext(), res.winner.toString(), Toast.LENGTH_SHORT).show()
        ...
        binding.tvRequiredPercentage.text = getString(R.string.required_percentage, res.gameSettings.minPercentOfRightAnswers.toString())
        binding.tvScorePercentage.text = getString(R.string.score_percentage,
